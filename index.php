...
<head>
	...
	<title>Strongway</title>

	<link rel="stylesheet" href="../assets/css/style.css">

	<!-- CDN Styles to Bootstrap -->
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="copyright">
						<span class="text"> Strongway Webstudio - Todos os direitos reservados </span>
					</div>
				</div>
			</div>
		</div>
